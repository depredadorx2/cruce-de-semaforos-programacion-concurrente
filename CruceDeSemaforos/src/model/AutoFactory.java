...
public class AutoFactory {
	 ...
	 * @return
	 */
	public AutoCruceSimple makeAutoOEHaciaSur(int velocidad, String modelo,
			 Semaforo semaSuCalle, int id) {

		AutoCruceSimple auto = new AutoCruceSimple(velocidad,  this.sectorSO, modelo,
	 ...
	 * @return
	 */
	public AutoCruceSimple makeAutoSurHaciaDerecha(int velocidad, String modelo,
			 Semaforo semaSuCalle, int id) {

		AutoCruceSimple auto = new AutoCruceSimple(velocidad, this.sectorSE, modelo,
